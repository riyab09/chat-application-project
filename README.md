ChatApp Description ChatApp is a real-time messaging application built using Django and Channels. Users can join different chat rooms and send/receive messages instantly through WebSockets.
